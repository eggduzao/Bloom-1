...
def main():
  ...
  *Return:*
  ...
  sica_bonuscrosslb_range = opts.sica_bonuscrosslb_range.split(",")
  sica_bonuscross_range = opts.sica_bonuscross_range.split(",")
  sica_bonuslb_range = opts.sica_bonuslb_range.split(",")
  goba_vertical_multiplier = opts.goba_vertical_multiplier.split(",")
  goba_ortogonal_multiplier = opts.goba_ortogonal_multiplier.split(",")
  ...
  sica_instance = Sica(cores, contact_map, avoid_distance, removed_dict = preprocess_instance.removed_dict, pvalue_threshold = sica_pvalue_threshold,
                       ...
                       bonuscrosslb_range = sica_bonuscrosslb_range, bonuscross_range = sica_bonuscross_range, bonuslb_range = sica_bonuslb_range)
