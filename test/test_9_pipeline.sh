...
cores="--cores=4"
temporary_location="--temporary-location=/usr/users/egadegu/Projects/Papantonis_Bloom/Bloom/test/temp/test_9_pipeline/" # Change to your path (created)
